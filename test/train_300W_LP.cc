...
//    params.bagging_overlap = 0.4;
    params.model_filename = "../models/300w_lp.xml";
...
//    cv::String imageFiles = "../data/01_Indoor_images.txt";
//    cv::String ptsFiles = "../data/01_Indoor_points.txt";
    cv::String imageFiles = "/home/public/nfs72/3000_train/align_3000fps_cv/data/300W-LP_images.txt";
    cv::String ptsFiles = "/home/public/nfs72/3000_train/align_3000fps_cv/data/300W-LP_points.txt";
...
//        cv::resize(gray, gray, gray.size()/2);
        ext::loadFacePoints(landmarks_train[i], facial_points, 68, ','); //pts
...
//        facemark->addTrainingSample(gray, facial_points);
        ...
        cv::Rect aug_rect;
        augment_transform(gray, facial_points, aug_img, aug_points, aug_rect);
